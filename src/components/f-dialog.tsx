...
export function FormDialog(props: { children: JSX.Element, triggerText: string, className?: string }) {
    return <AlertDialog modal>
        <AlertDialogTrigger class={`py-2 px-4 rounded-lg text-sm font-medium ${props.className}`}>{props.triggerText}</AlertDialogTrigger>
